            ...
            <div class="row justify-content-center align-items-center">
              <div class="col-lg-7 text-center pt-lg">
                ...
                <div class="btn-wrapper">
                  ...
                  <a href="https://themewagon.com/themes/free-bootstrap-4-design-system/" class="btn btn-white btn-icon mb-3 mb-sm-0">
      ...
      <div class="container">
        <div class="row row-grid justify-content-center">
          <div class="col-lg-8 text-center">
            ...
            <div class="btn-wrapper">
              <a href="https://themewagon.com/themes/free-bootstrap-4-design-system/" class="btn btn-primary mb-3 mb-sm-0">Download HTML</a>
            </div>
            <div class="text-center">
    ...
    <div class="container">
      ...
      <div class="row align-items-center justify-content-md-between">
        <div class="col-md-6">
          <div class="copyright">
            &copy; 2018
            <a href="https://www.creative-tim.com" target="_blank">Creative Tim</a> | Distribution: <a href="https://themewagon.com/">ThemeWagon</a>
          </div>
        </div>
        <div class="col-md-6">
